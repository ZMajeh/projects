...
void BookViewer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        BookViewer *_t = static_cast<BookViewer *>(_o);
        switch (_id) {
        case 0: _t->on_adder_click(); break;
        case 1: _t->on_remover_click(); break;
        case 2: _t->on_page_click(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObjectExtraData BookViewer::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject BookViewer::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_BookViewer,
      qt_meta_data_BookViewer, &staticMetaObjectExtraData }
};
